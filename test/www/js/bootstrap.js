...
Ext.Loader.addClassPathMappings({
  "Ext": "js/lib/extjs/src",
  "Ext.DomHelper": "js/lib/extjs/src/dom/Helper.js",
  "Ext.DomQuery": "js/lib/extjs/src/dom/Query.js",
  "Ext.EventObjectImpl": "js/lib/extjs/src/EventObject.js",
  "Ext.Msg": "js/lib/extjs/src/window/MessageBox.js",
  "Ext.Supports": "js/lib/extjs/src/Support.js",
  "Ext.core.DomHelper": "js/lib/extjs/src/dom/Helper.js",
  "Ext.core.DomQuery": "js/lib/extjs/src/dom/Query.js",
  "Ext.rtl.EventObjectImpl": "js/lib/extjs/src/rtl/EventObject.js",
  "ExtThemeNeptune": "js/lib/extjs/packages/ext-theme-neptune/overrides"
});
...
Ext.setVersion("ext-theme-neptune-acaa5234-ec2a-4ab1-aa9f-89f2fe608c40", "1.0.0");
 ...
 * metadata-driven class system features
 */
Ext.Loader.loadScriptFile('js/lib/extjs/packages/ext-theme-neptune/overrides/Component.js', Ext.emptyFn);
Ext.Loader.loadScriptFile('js/lib/extjs/packages/ext-theme-neptune/overrides/toolbar/Toolbar.js', Ext.emptyFn);
Ext.Loader.loadScriptFile('js/lib/extjs/packages/ext-theme-neptune/overrides/layout/component/Dock.js', Ext.emptyFn);
Ext.Loader.loadScriptFile('js/lib/extjs/packages/ext-theme-neptune/overrides/panel/Panel.js', Ext.emptyFn);
Ext.Loader.loadScriptFile('js/lib/extjs/packages/ext-theme-neptune/overrides/container/ButtonGroup.js', Ext.emptyFn);
Ext.Loader.loadScriptFile('js/lib/extjs/packages/ext-theme-neptune/overrides/toolbar/Paging.js', Ext.emptyFn);
Ext.Loader.loadScriptFile('js/lib/extjs/packages/ext-theme-neptune/overrides/picker/Month.js', Ext.emptyFn);
Ext.Loader.loadScriptFile('js/lib/extjs/packages/ext-theme-neptune/overrides/form/field/HtmlEditor.js', Ext.emptyFn);
Ext.Loader.loadScriptFile('js/lib/extjs/packages/ext-theme-neptune/overrides/panel/Table.js', Ext.emptyFn);
Ext.Loader.loadScriptFile('js/lib/extjs/packages/ext-theme-neptune/overrides/grid/RowEditor.js', Ext.emptyFn);
Ext.Loader.loadScriptFile('js/lib/extjs/packages/ext-theme-neptune/overrides/grid/column/RowNumberer.js', Ext.emptyFn);
Ext.Loader.loadScriptFile('js/lib/extjs/packages/ext-theme-neptune/overrides/resizer/Splitter.js', Ext.emptyFn);
Ext.Loader.loadScriptFile('js/lib/extjs/packages/ext-theme-neptune/overrides/menu/Separator.js', Ext.emptyFn);
Ext.Loader.loadScriptFile('js/lib/extjs/packages/ext-theme-neptune/overrides/menu/Menu.js', Ext.emptyFn);
Ext.Loader.loadScriptFile('js/lib/extjs/packages/ext-theme-neptune/overrides/panel/Tool.js', Ext.emptyFn);
Ext.Loader.loadScriptFile('js/lib/extjs/packages/ext-theme-neptune/overrides/tab/Tab.js', Ext.emptyFn);
