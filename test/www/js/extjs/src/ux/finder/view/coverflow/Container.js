 ...
 */
Ext.define('Ext.ux.finder.view.coverflow.Container', {
    extend: 'Ext.Container',
    alias: 'widget.coverflow',
    orientation: 'horizontal',
    requires: ['Ext.ux.finder.view.coverflow.Image'],
    item: 0,
    ...
    afterLayout: function () {
        ...
        var css = [];
        css[this.props[2]] = this._calculateBodyOffset();
    ...
    _calculateBodyOffset: function () {
        ...
        return (this.recenter ? -this.current * this.itemSize / 2 : 0) // TODO-this might not be itemSize!
            +
