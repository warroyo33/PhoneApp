 ...
 *     });
 */
Ext.define('Ext.ux.tab.Panel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.extendedtabpanel',
    ...
    initComponent: function() {
        ...
        var leftToolbar= Ext.create("Ext.toolbar.Toolbar",{
            width: me.tabBarConfig.leftBar.width,

            items: me.tabBarConfig.leftBar.items
        });
        var leftToolBarWrapper= Ext.create("Ext.container.Container",{
            dock:'left',
            layout: 'fit',
            items:[leftToolbar]
        });
        var rightToolbar= Ext.create("Ext.toolbar.Toolbar",{
            width: me.tabBarConfig.rightBar.width,
            enableOverflow:true,
            rtl: true,
            items: me.tabBarConfig.rightBar.items
        });
        var rightToolBarWrapper= Ext.create("Ext.container.Container",{
            dock:'right',
            layout: 'fit',
            items:[rightToolbar]
        });

        var tabBarContainer=Ext.create("Ext.panel.Panel",{
            layout: 'fit',
            items:[me.tabBar],
            dockedItems: [leftToolBarWrapper,rightToolBarWrapper]
        });
        dockedItems.push(tabBarContainer);
