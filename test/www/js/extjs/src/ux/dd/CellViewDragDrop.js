 ...
 *     });
 */
Ext.define('Ext.ux.dd.CellViewDragDrop', {
    extend: 'Ext.AbstractPlugin',
    alias: 'plugin.cellviewdragdrop',
    requires: ['Ext.ux.dd.CellViewDropZone'],
    uses: [
        'Ext.view.DragZone',
        'Ext.ux.dd.CellViewDropZone'
    ],
    ...
    onViewRender : function(view) {
        ...
        if (me.enableDrop) {
            me.dropZone = new Ext.ux.dd.CellViewDropZone(Ext.apply({
                view: view,
