 ...
 * @private
 */
Ext.define('Ext.ux.dd.CellDropZone', {
...
//      If we fall through because the mouse is below the nodes (or there are no nodes), we'll get an onContainerOver call.
    ...
    getPosition: function(e, node) {
        ...
        if ((region.left - x) >= (region.left - region.right) / 2) {
            pos = "before";
        } else {
            pos = "after";
        }
    ...
    positionIndicator: function(node, data, e) {
        ...
        if (!Ext.Array.contains(draggingRecords, overRecord) && (
            ...
            if (me.overRecord != overRecord || me.currentPosition != pos) {
                ...
                me.getIndicator().setWidth(1).setHeight(Ext.fly(view.el).getHeight()).showAt(indicatorX, 0);
    ...
    onContainerOver : function(dd, e, data) {
        ...
        // No records, position the indicator at the top
            ...
            me.overRecord = me.currentPosition = null;
            me.getIndicator().setWidth(1).setHeight(Ext.fly(view.el).getHeight()).showAt(0, 0);
            me.valid = true;
        }
