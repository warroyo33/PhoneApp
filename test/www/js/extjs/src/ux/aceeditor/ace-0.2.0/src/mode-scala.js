define("ace/mode/scala", ["require", "exports", "module", "ace/lib/oop", "ace/mode/javascript", "ace/tokenizer", "ace/mode/scala_highlight_rules"], function (a, b, c) {
    "use strict";
    var d = a("../lib/oop"), e = a("./javascript").Mode, f = a("../tokenizer").Tokenizer, g = a("./scala_highlight_rules").ScalaHighlightRules, h = function () {
...
}), define("ace/mode/scala_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/doc_comment_highlight_rules", "ace/mode/text_highlight_rules"], function (a, b, c) {
    "use strict";
    ...
    d.inherits(h, g), b.ScalaHighlightRules = h
})